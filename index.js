...
async function start() {
  ...
  let doorcode = await ask(
    "please punch in the numbers correctly in order to enter"
  );

  let count = 0;
  //giving the player 3 trys to get the code correct
  if (doorCode !== 1234) {

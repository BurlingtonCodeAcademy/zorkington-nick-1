...
const anteChamber = new Room(
  "ante chamber",
  "You have entered the Antechamber. Right to the right of you is an umbrella stand with a big stick in the stand.\n There is a massive chandlier in the center of the ceiling. It seems to be ever so slightly blowing in the breeze.\n Meanwhile, you heard the door lock behind you.",
  [],
  null,
  null,
  true,
...
const ticketstub = new Items("ticketstub", "You recive a ticket stub for your rainjacket, also on the back it reads:'Good for 1 Free Bottle of Scotch'", true)
